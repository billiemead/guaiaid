...
class diza_setup_theme {
    ...
    public function add_scripts() {
        ...
        diza_get_elementor_post_scripts();
        ...
        wp_enqueue_script('waypoints', DIZA_SCRIPTS . '/jquery.waypoints' . $suffix . '.js', array(), '4.0.0', true); 
    ...
    public function load_admin_login_styles() {
        wp_enqueue_style( 'diza-login-admin', DIZA_STYLES . '/admin/login-admin.css', array(), false, '1.0.0' );
    }
 
    public function load_admin_styles() {
        wp_enqueue_style( 'material-design-iconic-font', DIZA_STYLES . '/material-design-iconic-font.css', array(), false, '2.2.0' ); 
        wp_enqueue_style( 'diza-custom-admin', DIZA_STYLES . '/admin/custom-admin.css', array(), false, '1.0.0' );
    ...
    public function setup() {
        ...
        if( apply_filters('diza_remove_widgets_block_editor', true) ) {
    ...
    public function fonts_url() {
        ...
        */
        $Nunito_Sans       = _x( 'on', 'Nunito Sans font: on or off', 'diza' );
        $Roboto            = _x( 'on', 'Roboto font: on or off', 'diza' );
