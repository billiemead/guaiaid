...
class Diza_Elementor_Account extends Diza_Elementor_Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'text_before',
            [
                'label'              => esc_html__('Text Before Login', 'diza'),
        ...
        $this->add_control(
            'text_after',
            [
                'label'              => esc_html__('Text After Login', 'diza'),
                'type'               => Controls_Manager::TEXT,
                'condition'          => [
                    'show_text_account' => 'yes'
                ]        
...
$widgets_manager->register(new Diza_Elementor_Account());
