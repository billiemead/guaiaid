...
if ( ! function_exists( 'diza_remove_shop_loop_item_title' ) ) {
  add_action( 'init', 'diza_remove_shop_loop_item_title', 10 ); 
  function diza_remove_shop_loop_item_title() {
 ...
 */
add_action('diza_shop_list_sort_description','woocommerce_template_single_excerpt', 5);