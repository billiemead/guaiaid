...
if ( ! class_exists( 'Diza_WooCommerce' ) ) :
	...
	class Diza_WooCommerce {
		...
		private function init_hooks() {
			...
			add_action('wp_ajax_woocommerce_diza_quantity_mini_cart', array($this, 'diza_quantity_mini_cart'));
			add_action('wp_ajax_nopriv_woocommerce_diza_quantity_mini_cart', array($this, 'diza_quantity_mini_cart'));
			// WC AJAX can be used for frontend ajax requests.
			add_action('wc_ajax_diza_quantity_mini_cart', array($this, 'diza_quantity_mini_cart'));
		...
		public function product_per_page_fillter() {
	        ...
	        $options['-1'] = esc_html__('All products', 'diza' );
		...
		public function product_category_fillter() {
	        ...
	        $options = array();
	        $class = array();
	        $options['-1'] = esc_html__('All Categories', 'diza' );
	        $class[] = 'level-0';
		...
		public function yith_add_wcwl_link_my_account( $items ) {
			...
			$items[$slug]                       =   esc_html__( 'My Wishlist', 'diza' );
			$items['edit-address']              =   esc_html__( 'Addresses', 'diza' );
			$items['payment-methods']           =   esc_html__( 'Payment methods', 'diza' );
			$items['edit-account']              =   esc_html__( 'Account details', 'diza' );
			$items['customer-logout']           =   esc_html__( 'Logout', 'diza' );
		...
		public static function diza_quantity_mini_cart() {
