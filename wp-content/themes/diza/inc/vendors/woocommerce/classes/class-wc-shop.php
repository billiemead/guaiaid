...
if ( ! class_exists( 'Diza_Shop_WooCommerce' ) ) :
	...
	class Diza_Shop_WooCommerce  {
		...
		public function __construct() {
			...
			add_filter( 'admin_init', array( $this, 'woof_settings_per_page'), 10 );
		...
		public function woof_settings_per_page() {
			$settings = get_option('woof_settings');
			$settings['per_page'] = diza_tbay_get_global_config('number_products_per_page', 12);
