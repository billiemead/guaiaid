...
if (!class_exists('Diza_Redux_Framework_Config')) {
    ...
    class Diza_Redux_Framework_Config
    {
        ...
        {
            $this->default_fonts = diza_tbay_default_theme_primary_fonts();
        }
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable "Ajax Dropdown" Mega Menu', 'diza'),
                        'default' => false,
                    ),
                )
            );  
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array (
                        ...
                        'icon' => true,
                        'type' => 'info',
                        'raw' => '<h3 style="margin: 0;"> '.esc_html__('Font Primary', 'diza').'</h3>',
                        'required' => array('show_typography','=', true),
                    ),                    

                    // Standard + Google Webfonts
                    array (
                        'title' => esc_html__('Font Face Primary', 'diza'),
                        'id' => 'main_font',
                        'type' => 'typography',
                        'line-height' => false,
                        'text-align' => false,
                    ...
                    // Google Custom                        
                    array (
                        'title' => esc_html__('Google Font Face Primary', 'diza'),
                    ...
                    // main Custom fonts                      
                    array (
                        'title' => esc_html__('Custom Font Face Primary', 'diza'),
                    ...
                    array (
                        ...
                        'icon' => true,
                        'type' => 'info',
                        'raw' => '<h3 style="margin: 0;"> '.esc_html__('Font Second', 'diza').'</h3>',
                        'required' => array( 
                            array('show_typography','=', true),
                    ...
                    // Standard + Google Webfonts
                    array (
                        'title' => esc_html__('Font Face Second', 'diza'),
                        'id' => 'main_font_second',
                        'type' => 'typography',
                        'line-height' => false,
                        'text-align' => false,
                    ...
                    // Google Custom                        
                    array (
                        'title' => esc_html__('Google Font Face Second', 'diza'),
                        'subtitle' => '<em>'.esc_html__('Enter your Google Font Name for the theme\'s Main Typography', 'diza').'</em>',
                        'desc' => esc_html__('e.g.: &#39;Open Sans&#39;, sans-serif', 'diza'),
                    ...
                    // main Custom fonts                      
                    array (
                        'title' => esc_html__('Custom Font Face Second', 'diza'),
                        'subtitle' => '<em>'.esc_html__('Enter your Custom Font Name for the theme\'s Main Typography', 'diza').'</em>',
                        'desc' => esc_html__('e.g.: &#39;Open Sans&#39;, sans-serif', 'diza'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Enable Quantity on Mini-Cart', 'diza'),
                        'default' => true
                    ),
                )
            ); 
