	...
	public function import_files(){
		return array(
			array(
				...
				'home'                       => 'home',
				'import_file_url'          	 => "http://demosamples.thembay.com/diza/protective-suit/data.xml",
				'import_widget_file_url'     => "http://demosamples.thembay.com/diza/protective-suit/widgets.wie",
				'import_redux'         => array(
					array(
						'file_url'   => "http://demosamples.thembay.com/diza/protective-suit/home/redux_options.json",
						'option_name' => 'diza_tbay_theme_options',
					),
				),
				'rev_sliders'                => array(
					"http://demosamples.thembay.com/diza/protective-suit/revslider/slider-protective-suit.zip",
				),
				'import_preview_image_url'   => "http://demosamples.thembay.com/diza/protective-suit/home/screenshot.jpg",
			...
			array(
				...
				'home'                       => 'home',
				'import_file_url'          	 => "http://demosamples.thembay.com/diza/medicine/data.xml",
				'import_widget_file_url'     => "http://demosamples.thembay.com/diza/medicine/widgets.wie",
				'import_redux'         => array(
					array(
						'file_url'   => "http://demosamples.thembay.com/diza/medicine/home/redux_options.json",
						'option_name' => 'diza_tbay_theme_options',
					),
				),
				'rev_sliders'                => array(
					"http://demosamples.thembay.com/diza/medicine/revslider/slider-medicine.zip",
				),
				'import_preview_image_url'   => "http://demosamples.thembay.com/diza/medicine/home/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'diza' ),
			...
			array(
				...
				'home'                       => 'home',
				'import_file_url'          	 => "http://demosamples.thembay.com/diza/care/data.xml",
				'import_widget_file_url'     => "http://demosamples.thembay.com/diza/care/widgets.wie",
				'import_redux'         => array(
					array(
						'file_url'   => "http://demosamples.thembay.com/diza/care/home/redux_options.json",
						'option_name' => 'diza_tbay_theme_options',
					),
				),
				'rev_sliders'                => array(
					"http://demosamples.thembay.com/diza/care/revslider/slider-care.zip",
				),
				'import_preview_image_url'   => "http://demosamples.thembay.com/diza/care/home/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'diza' ),
