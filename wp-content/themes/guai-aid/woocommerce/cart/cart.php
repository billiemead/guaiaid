...
<div class="row">
    <div class="col-12 col-md-8">
        <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                        ...
                        ?>
                            ...
                            <td class="product-remove">
                                ...
                                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    ...
                                    sprintf(
                                        '<a href="%s" class="remove btn btn-danger btn-sm" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="far fa-trash-alt"></i></a>',
            ...
            ?>
                        ...
                        <tr>
                            <td colspan="2" class="actions border-right-0">
                                <?php if ( wc_coupons_enabled() ) { ?>
                                <div class="input-group coupon">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text m-0 coupon_code" for="">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-dark" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>">
                            ...
                            <td colspan="4" class="actions border-left-0 text-right">
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="cart-collaterals border p-4">
            <?php
        /**
