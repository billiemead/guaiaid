    ...
    <tr>
        <td colspan="6" class="actions">
            <div class="coupon">
                ...
                <input type="text" name="pw_gift_card" class="input-text form-control" id="pwgc-redeem-gift-card-number" value="" placeholder="<?php esc_attr_e( 'Gift card number', 'pw-woocommerce-gift-cards' ); ?>" />
