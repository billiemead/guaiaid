    ...
    <div id="pwgc-redeem-gift-card-form">
        <form id="pwgc-redeem-form">
            <div id="pwgc-redeem-gift-card-container">
                ...
                <input type="text" id="pwgc-redeem-gift-card-number" class="form-control w-100" name="card_number" autocomplete="off" placeholder="<?php esc_html_e( 'Gift card number', 'pw-woocommerce-gift-cards' ); ?>">
                <input type="submit" id="pwgc-redeem-button" class="button btn btn-dark w-100" name="redeem_gift_card" value="<?php esc_html_e( 'Apply', 'pw-woocommerce-gift-cards' ); ?>" data-wait-text="<?php esc_html_e( 'Please wait...', 'pw-woocommerce-gift-cards' ); ?>">
            </div>
        </form>
    </div>
    <?php
