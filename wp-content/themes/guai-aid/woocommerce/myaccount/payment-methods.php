...
<h2 class="page-title mt-0 mb-3">
    <?php _e('Payment methods','guai-aid');?>
</h2>
<hr>
<?php if ( $has_methods ) : ?>
...
<?php else : ?>
	...
	<div class="alert alert-info"><?php esc_html_e( 'No saved methods found.', 'woocommerce' ); ?></div>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="btn btn-dark" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
<?php endif; ?>
