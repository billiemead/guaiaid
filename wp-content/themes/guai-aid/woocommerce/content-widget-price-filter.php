...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
    <div class="price_slider_wrapper">
        ...
        <div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
            ...
            <div class="price_label  mt-2" style="display:none;">
                <?php echo esc_html__( 'Price:', 'woocommerce' ); ?> <span class="from"></span> &mdash; <span class="to"></span>
            </div>
            <?php echo wc_query_string_form_fields( null, array( 'min_price', 'max_price', 'paged' ), '', true ); ?>
            <button type="submit" class="button btn btn-dark btn-sm px-5 mt-2">
                <?php echo esc_html__( 'Filter', 'woocommerce' ); ?></button>
            <div class="clear"></div>
        </div>
    </div>
</form>
