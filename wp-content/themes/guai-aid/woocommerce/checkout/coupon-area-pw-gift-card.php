...
if ( 'before_checkout_form' === get_option( 'pwgc_redeem_checkout_location', 'review_order_before_submit' ) ) {
	...
	<form class="checkout_pw_gift_card woocommerce-form-coupon" method="post" style="display:none">
		...
		<p class="form-row form-row-first">
			<input type="text" name="pw_gift_card_number" class="input-text form-control" placeholder="<?php esc_attr_e( 'Gift card number', 'pw-woocommerce-gift-cards' ); ?>" id="pwgc-redeem-gift-card-number" value="" />
		</p>
