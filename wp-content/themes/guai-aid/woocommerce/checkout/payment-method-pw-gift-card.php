...
if ( 'review_order_before_submit' === get_option( 'pwgc_redeem_checkout_location', 'review_order_before_submit' ) ) {
    ...
    <div id="pwgc-redeem-gift-card-form">
        <form id="pwgc-redeem-form">
            ...
            <input type="text" id="pwgc-redeem-gift-card-number" class="form-control border bg-white" name="card_number" autocomplete="off" placeholder="<?php esc_html_e( 'Gift card number', 'pw-woocommerce-gift-cards' ); ?>">
